...
import (
	...
	"releaseaapi/internal/features/audit/api"
	"releaseaapi/internal/features/auth/api"
	"releaseaapi/internal/features/credentials/api"
	"releaseaapi/internal/features/deploys/api"
	"releaseaapi/internal/features/environments/api"
	"releaseaapi/internal/features/externalendpoints/api"
	"releaseaapi/internal/features/governance/api"
	"releaseaapi/internal/features/identity/api"
	"releaseaapi/internal/features/observability/api"
	"releaseaapi/internal/features/operations/api"
	"releaseaapi/internal/features/profile/api"
	"releaseaapi/internal/features/projects/api"
	"releaseaapi/internal/features/ruledeploys/api"
	"releaseaapi/internal/features/rules/api"
	"releaseaapi/internal/features/scm/api"
	"releaseaapi/internal/features/services/api"
	"releaseaapi/internal/features/settings/api"
	"releaseaapi/internal/features/teams/api"
