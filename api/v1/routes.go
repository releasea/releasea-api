...
import (
	...
	"releaseaapi/api/v1/audit"
	"releaseaapi/api/v1/auth"
	"releaseaapi/api/v1/credentials"
	"releaseaapi/api/v1/deploys"
	"releaseaapi/api/v1/environments"
	"releaseaapi/api/v1/externalendpoints"
	"releaseaapi/api/v1/governance"
	"releaseaapi/api/v1/identity"
	"releaseaapi/api/v1/observability"
	"releaseaapi/api/v1/operations"
	"releaseaapi/api/v1/profile"
	"releaseaapi/api/v1/projects"
	"releaseaapi/api/v1/ruledeploys"
	"releaseaapi/api/v1/rules"
	"releaseaapi/api/v1/scm"
	"releaseaapi/api/v1/security"
	"releaseaapi/api/v1/services"
	"releaseaapi/api/v1/settings"
	"releaseaapi/api/v1/shared"
	"releaseaapi/api/v1/teams"
	"releaseaapi/api/v1/templates"
	"releaseaapi/api/v1/workers"
...
func registerPublicRoutes(rg *gin.RouterGroup) {
	...
	authGroup.Use(security.AuthRateLimitMiddleware())
...
func registerServiceRoutes(rg *gin.RouterGroup) {
	...
	rg.POST("/services/:id/start", services.StartService)
	rg.POST("/services/:id/stop", services.StopService)
	rg.POST("/services/:id/restart", services.RestartService)
